      ...
      <div className="flex flex-col items-center gap-12 md:flex-row md:justify-center md:items-start md:gap-16 lg:gap-24">
        {items.map((item) => (
          ...
          >
            ...
            <div className="relative flex flex-col items-center justify-center w-[200px] h-[120px] md:w-[190px] md:h-[110px] lg:w-[220px] lg:h-[130px] border border-primary/30 transition-all duration-500 group-hover:border-primary">
